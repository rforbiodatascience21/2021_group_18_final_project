...
>>>>>>> db773f6217fba4cd74cc7e6c5b9a32bde5d28ff9
```

# Introduction 
## Data
- The breast cancer consists of 4 cancer group, and 3 healthy patients as well as 
```{r cancer class, echo=FALSE}
joined_data %>%
...
## Goals
- Exploration and identifying patterns of the data
- Create visulation of the data 
- Predict breast cancer class by looking at gene expressions
...
Lots of the represented genes expression do not contain NA vlaues. Thereby, all of them was removed from the plot, to get a better estimate of where to cut the lowest wanted fraction of NAs.  
```{r cancer class, echo=FALSE, warning=FALSE, message=FALSE}
...
proteomes_clean %>%
  ...
  count()
```
For this, we end up removing 2205 genes.
...
The Heat map is created on relevant breats cancer genes.  
```{r cancer class, echo=FALSE, warning=FALSE, message=FALSE}
fractionNA_All + fractionNA_without0
